...
for strain in strains:
    for direction in directions:
        ...
        if not subset.empty:
            ...
            ax.plot(subset['Temperature'], subset['ZTMAX'], 
                    color=colors[strain], 
...
# \mathbf{} 既能将字母加粗，又能强制其显示为符合学术规范的正体
ax.set_ylabel('Figure of merit, $\mathbf{ZT}_{\mathbf{max}}$', fontweight='bold')
...
#          handlelength=2.5, fontsize=13, labelspacing=0.8)
...
# === 6. 输出高精度图片 ===
plt.tight_layout() 
plt.savefig("ZTmax_vs_Temperature_NatureStyle_EN.pdf", dpi=600, bbox_inches='tight')
plt.savefig("ZTmax_vs_Temperature_NatureStyle_EN.png", dpi=600, bbox_inches='tight')
